...
from sqlalchemy import ( Column, Integer, String, Enum as SqlEnum, Text, DateTime, ForeTime, ForignKey, func )
...
class Appointment(Base):
    ...
    appointment_type = Column(SqlEnum(AppointmentTypeEnum), default=AppointmentTypeEnum.Consulation, nullable=False )
    status = Column(SqlEnum(AppointmentStatusEnum), default=AppointmentStatusEnum.Scheduled, nullable=False)
