var FormElement = function() {"use strict" ;
    /* function to initiate jquery.maskedinput */
    var  maskInputHandler = function() {
        $.mask.definitions['~'] = '[+-]';
        $('.input-mask-date').mask('99/99/9999');
        $('.input-mask-phone').mask('(999) 999-9999');
        $('.input-mask-eyestrict').mask('~9.99 ~9.99 999');
        $('.input-mask-product').mask('a*-999-a999', {
            placehodler : " ",
            completed : function() {
                alert("you type the following : " + this.val());
            }
        });
    };
    /* function to intiate bootstrap-touchspin */
